...
export default function CallForPaperScreen() {
  ...
  const handleDownloadReference = () => {
    Linking.openURL(
      "https://docs.google.com/document/d/1DeMxiG8nQSAboQRyLUP0trAVM_LCm7FtRCRopskE6eo/edit?tab=t.0#heading=h.56hvy77yvf58"
    );
  };
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.referenceSection}>
          <TouchableOpacity
            ...
            onPress={handleDownloadReference}
          >
            <Text style={styles.referenceButtonText}>
              Reference Abstract Body Structure
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.instructionsSection}>
          ...
          <Text style={styles.instructionText}>
            ✏️ Edit the file and upload and abstract submission portal (exactly
            above &quot;Reference Abstract Body structure&quot; button.
          </Text>
        </View>
